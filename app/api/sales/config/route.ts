...
const EDITABLE = ['agent_name', 'language', 'voice', 'goal', 'opening_line', 'persona', 'guidelines', 'dos', 'donts', 'booking_link', 'max_duration', 'record_calls', 'ai_disclosure', 'disclosure_text', 'transfer_number', 'voicemail_detection', 'voicemail_message'] as const;
